...
EYE_AR_CONSECUTIVE_FRAMES = 15  #Number of consecutive frames to confirm a blink
WINK_AR_DIFF_THRESH = 0.04  # Threshold for eye aspect ratio difference for wink detection
WINK_AR_CLOSE_THRESH = 0.19 # Threshold for eye aspect ratio for close eye detection
WINK_CONSECUTIVE_FRAMES = 10 # Number of consecutive frames to confirm a wink
